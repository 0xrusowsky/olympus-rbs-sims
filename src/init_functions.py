...
def initial_params(netflow_type:str, netflow_data:str=None, initial_date:str=None, initial_supply:float=None, initial_reserves_stables:float=None, initial_liq_stables:float=None, initial_price:float=None, initial_target:float=None):
